...
analysis = {
    ...
    "strategic_threads": [
        {
            "title": "Jio IPO unlock — value crystallization on the way",
            "category": "capital",
            "the_move": "Mukesh Ambani publicly confirmed Jio Platforms listing is 'advancing steadily.' First explicit timeline signal from the chairman.",
            "evidence": "Jio Platforms listing is advancing steadily.",
            "evidence_speaker": "Mukesh Ambani, CMD",
            "forward_read": "At Jio FY26 EBITDA of ₹76,255 Cr × 12–15× EV/EBITDA (in line with global telco-tech peers) → $110–135 Bn equity value crystallization. Triggers a SOTP re-rating for the parent (currently ~11× forward PE), where investors have been giving Jio zero credit relative to its actual contribution.",
            "impact_horizon": "6-12m",
            "segments_affected": ["Digital Services", "Parent re-rating"],
            "hindrances": [
                "SEBI dilution norms still in flux — even with the relaxed 2.5% threshold, anchor allocation rules could push timeline",
                "Market window risk — telco IPOs need broader market momentum; a risk-off period kills the narrative",
                "Anchor investor valuation push-back at the upper end ($130B+) — may force priced lower than envisioned",
                "Geopolitical tail risk dampening FII appetite for India primary market",
            ],
            "next_q_check": "DRHP filing announcement to BSE / SEBI. Track corporate filings page weekly.",
            "confidence": "high",
        },
        {
            "title": "Retail hyper-local engine — invest now, harvest in 18–24 months",
            "category": "product",
            "the_move": "Reliance Retail compressed margin 60 bps deliberately to fund 1,200+ city hyper-local network rollout. JioMart customers nearly doubled (+98% YoY), hyper-local daily orders up 300%.",
            "evidence": "FY26 marks a year of profitable growth at scale for Reliance Retail.",
            "evidence_speaker": "Isha Ambani, ED, RR Ventures",
            "forward_read": "Margin compression is the cost of building India's widest hyper-local network — 3,100+ stores, 5,100+ pin codes. Once fixed-cost absorption kicks in (likely H2 FY27), retail EBITDA margin should recover to 8.5–9% range. By FY28, this stack — Blinkit + Zepto + Myntra + Tata Cliq under one roof, AjioRush 4-hour fashion delivery — is structurally moated. Mgmt explicitly flagged 'margin restoration' as FY27 priority.",
            "impact_horizon": "12-24m",
            "segments_affected": ["Reliance Retail"],
            "hindrances": [
                "Quick-commerce burn rates from Blinkit/Zepto could force RR to keep subsidising deliveries longer",
                "Last-mile cost inflation — driver economics worsening across India",
                "Customer acquisition cost rising as easy users acquired; next cohort harder",
                "Hyper-local unit economics still unproven at this scale outside top-30 cities",
            ],
            "next_q_check": "Retail EBITDA margin direction in Q1 FY27 — does it stop declining? Hyper-local cohort retention numbers if disclosed.",
            "confidence": "medium",
        },
        {
            "title": "O2C base-effect tailwind setup",
            "category": "regulatory",
            "the_move": "Reliance voluntarily absorbed Q4 conflict-driven costs (Strait of Hormuz crude premiums, freight, insurance, SAED return) and held retail fuel prices steady, sacrificing margin to support consumers + national priorities. EBITDA fell 3.7% despite refining cracks running 148% above prior year.",
            "evidence": "O2C EBITDA ₹14,520 Cr (−3.7% YoY) despite Singapore Gasoil cracks +148%",
            "forward_read": "If conflict normalises in H1 FY27, the artificially compressed Q4 base creates a meaningful YoY tailwind for next year's prints. Even partial normalisation (say 50% of premiums fade) lifts segment EBITDA back to 9–10% segment margin range. Decision was clearly tactical — not structural — making this asymmetric to upside.",
            "impact_horizon": "3-6m",
            "segments_affected": ["O2C"],
            "hindrances": [
                "Conflict persistence in ME — Strait premiums could stay elevated for 2+ more quarters",
                "SAED diesel/ATF export levy could be made permanent",
                "Government may continue requesting voluntary fuel-price holds through FY27",
                "Refining cracks themselves could mean-revert from current peaks",
            ],
            "next_q_check": "Q1 FY27 O2C EBITDA. Singapore Gasoil + Jet/Kero cracks tracking. Any commentary on price-setting freedom restoration.",
            "confidence": "medium",
        },
        {
            "title": "New Energy quiet build — invisible until FY28",
            "category": "capex",
            "the_move": "'Others (incl. New Energy)' segment EBITDA grew 21% to ₹2,746 Cr — small base but accelerating. Solar giga-factory commissioning underway, battery storage in development. Mgmt avoided specific revenue guidance.",
            "evidence": "Others segment EBITDA +21.0% YoY · solar giga-factory + battery storage in build phase",
            "forward_read": "New Energy is currently invisible in the P&L but will start contributing real revenue from H2 FY27. By FY28, this segment could add ₹15–25K Cr to EBITDA at scale (back-of-envelope based on commissioned capacity), establishing Reliance as India's vertically integrated renewable platform. The optionality alone — given $7B committed capex — is currently being valued at zero by the market.",
            "impact_horizon": "24m+",
            "segments_affected": ["New Energy", "Others"],
            "hindrances": [
                "Solar module commodity prices — Chinese oversupply could compress unit economics",
                "Battery technology evolution — LFP vs solid-state vs sodium-ion; tech-bet risk",
                "Execution risk on multi-billion giga-factory commissioning — typical 6-9m delays in India",
                "Regulatory clarity on green hydrogen + battery storage tariffs",
            ],
            "next_q_check": "First commercial solar module shipment announcement. Any New Energy revenue line-item disclosure.",
            "confidence": "low",
        },
        {
            "title": "Jio's AI infrastructure pivot — connectivity-to-intelligence shift",
            "category": "product",
            "the_move": "Akash Ambani reframed Jio as 'the digital gateway to the Intelligence era' — a deliberate positioning shift from telco to AI distribution layer. Plus 524 Mn subs, 268 Mn 5G users, JioStar IPL audience of 515 Mn — captive distribution that no Indian AI company has.",
            "evidence": "Jio is the digital gateway to the Intelligence era.",
            "evidence_speaker": "Akash Ambani, Chairman, Jio Infocomm",
            "forward_read": "If Jio successfully monetises AI services (vertical-specific copilots, AI-powered consumer apps, B2B data-stack offerings to enterprises), this opens a new ARPU lever beyond tariff hikes. Even modest monetisation (₹50–100/month per user on a fraction of base) translates to ₹3–6K Cr annual revenue uplift. More importantly: it justifies a higher EV/EBITDA multiple at IPO — telco-tech vs pure telco.",
            "impact_horizon": "12-24m",
            "segments_affected": ["Digital Services"],
            "hindrances": [
                "Competitive — TCS, Infy, Wipro, plus US hyperscalers (Google, Microsoft) all bidding for the same AI distribution slot",
                "Execution gap from telco operations to AI infrastructure — different talent + product DNA",
                "Consumer AI monetisation models still unproven globally",
                "Regulatory risk on data localisation + AI governance frameworks",
            ],
            "next_q_check": "Any specific AI product launch announcement from Jio. Partnerships with hyperscalers or AI labs. Headcount additions in AI/ML.",
            "confidence": "low",
        },
    ],

    "concall_qa": [],  # Will be populated when transcript drops
